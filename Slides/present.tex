...
\begin{algorithm}[H]
  ...
  \ForAll{Composant}{
    \eIf{feuille de meme type existe}{
       remplace le non noeud non-terminal par une feuille.
    }{
     \eIf{Régle de même type}{
      traite la règle.\\
      remplace le non noeud non-terminal par les arbres de cette règle.
      }{
        remplace le non noeud non-terminal par feuille non remplaceable
      }
    }
  }
\end{algorithm}
